<template>
	<view class="page">
		...
		<free-list-item title="不让他看我" showRight :showLeftIcon="false" :showRightIcon="false">
			<switch slot="right" :checked="!!form.lookme" color="#08C060" @change="form.lookme = form.lookme ? 0 : 1" />
		</free-list-item>
		<free-list-item title="不看他" showRight :showLeftIcon="false" :showRightIcon="false">
		...
		<view class="py-3 flex align-center justify-center bg-white" hover-class="bg-light" @click="submit">
			<text class="font-md text-primary">{{id > 0 ? '同意' : '添加'}}</text>
		</view>
	</view>
</template>
